...
-- Change the **fill characters** for 'fold', `end of buffer` and *last line*.
...
-- BUG(messages, ruler): Custom `ruler format` with `custom statusline` can mess up incoming messages!
vim.o.ruler = true;
vim.o.rulerformat = " %l | %c";

-- I don't want to constantly go to the edge of the screen just to scroll.
vim.o.scrolloff = 999;
...
-- Enable spelling.
-- I also use camelCase & don't want spell on buffers with no syntax.
vim.o.spell = true;
...
-- Use the recommended settings for `markdown`.
